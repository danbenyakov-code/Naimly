...
export function BillingToggle() {
  ...
  return (
    <div>
      ...
      {/*
        * תנאי השימוש קובעים שהמחירים כוללים מע״מ. מחירון ששותק בנקודה
        * הזו יוצר פער בין מה שהלקוח ראה למה שייגבה ממנו — ובמחלוקת,
        * הנוסח שהלקוח ראה במסך הרכישה הוא שמכריע.
        */}
      <p className="mt-6 text-center text-sm text-[#718096]">
        כל המחירים כוללים מע״מ כדין. {TRIAL_DAYS} ימי התנסות ללא חיוב וללא כרטיס אשראי.
      </p>
    </div>
  );
}

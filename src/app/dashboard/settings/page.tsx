...
import { AcceptanceRecordCard } from "@/components/dashboard/acceptance-record-card";
    ...
    <div className="mx-auto max-w-[1060px]">
      ...
      <div className="mt-6 grid gap-5">
        ...
        <AcceptanceRecordCard
          ...
          acceptedAt={viewer.termsAcceptedAt}
          email={viewer.email}
          demo={viewer.demo}
        />

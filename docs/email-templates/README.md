...
| זרימה | קוד | קובץ |
|---|---|---|
| אימות הרשמה | `verifyOtp({ type: "signup" })` | [`actions.ts:172`](../../src/app/(auth)/actions.ts#L172) |
| שחזור סיסמה | `verifyOtp({ type: "recovery" })` | [`actions.ts:256`](../../src/app/(auth)/actions.ts#L256) |
